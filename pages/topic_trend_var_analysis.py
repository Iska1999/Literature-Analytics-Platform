# pages/topic_trend_var_analysis.py
import sys
import os
import pandas as pd
...
# ----- Streamlit App -----
st.set_page_config(page_title="Topic Trend VAR Analysis", layout="wide")
st.title("📊 Topic Trend VAR Analysis")
...
if st.button("🔍 Run Analysis"):
    try:
        with st.spinner('Running VAR analysis on topic trends...'):
            result = streamlit_functions.trend_analysis_var(
                "topic",
                selected_monthly,
